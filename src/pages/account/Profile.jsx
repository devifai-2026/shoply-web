          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
            <div className="space-y-3">
              ...
              <input
                ...
                className="w-full bg-surface border border-border-minimal rounded-[4px] py-4 px-6 focus:border-accent outline-none font-medium text-ink text-[13px]"
              />
            </div>
            <div className="space-y-3">
              <label className="text-[11px] font-normal uppercase text-ink tracking-[0.011em] pl-1">Primary Email</label>
              <input
                type="email"
                defaultValue={user?.email}
                readOnly
                className="w-full bg-surface border border-border-minimal rounded-[4px] py-4 px-6 outline-none font-medium text-ink text-[13px] opacity-60 cursor-not-allowed"
              />
            </div>
            <div className="space-y-3">
              <label className="text-[11px] font-normal uppercase text-ink tracking-[0.011em] pl-1">Contact Reference</label>
              <input
                type="tel"
                value={phone}
            ...
            <div className="space-y-3">
              <span className="text-[11px] font-normal uppercase text-ink tracking-[0.011em] pl-1">Validation State</span>
              <div className="mt-2 text-subtle text-[11px] font-normal uppercase tracking-[0.011em] bg-surface px-4 py-2 border border-border-minimal inline-block">
                Authenticated User
              </div>
            </div>
          </div>
